...
window.addEventListener("load", () => {
    ...
    const nodes = [
        { id: 1, name: "Home", icon: "home.svg" },
        { id: 2, name: "Bus Stop", icon: "home.svg" },
        { id: 3, name: "School", icon: "home.svg" },
        { id: 4, name: "Company", icon: "home.svg" },
        { id: 5, name: "Person", icon: "home.svg" },
    ];
    ...
    const container = svg.append("g").attr("class");
